...
import useHandleAccountSectionMenu from './hooks/useHandleAccountSectionMenu';

const AccountSection = () => {
    //Manejador para desplazar al menu de seleccionar perfil o el menu de la seccion cuenta, en el sidebar.
    const [distanceX, handleSectionDistanceX] = useHandleAccountSectionMenu();

    return (
        <div className={styles.accountSection_container}>
            <ul className={styles.accountSection_menu} style={{transform: `translateX(${distanceX}%)`}}>
                <li className={styles.accountSection_menu_item}>
                ...
                <li className={styles.accountSection_menu_item} onClick={() => {handleSectionDistanceX('profileMenu')}}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                ...
                <li className={styles.accountSection_menu_item} onClick={() => signOut()}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            ...
            <ul className={styles.signInOptions_userProfileMenu} style={{transform: `translateX(${distanceX}%)`}}>
                <span className="material-icons-round" onClick={() => {handleSectionDistanceX('accountMenu')}}>arrow_back_ios</span>
                <li className={styles.signInOptions_userProfileMenu_item}>
                    <span>Mi R3D</span>
